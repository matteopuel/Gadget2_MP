...
infile_2 = "test3/hernquist/vector/DDO154_benchmark_ann/out/snp_013" # annihilation only
#infile_2 = "test3/hernquist/vector/DDO154_benchmark_sgv/out/snp_013"
#infile_2 = "test3/hernquist/vector/DDO154_benchmark_latetime_osc/out/snp_013"
infile_3 = "test3/hernquist/vector/DDO154_benchmark_scatt/out/snp_013" # scattering only
#infile_3 = "test3/hernquist/vector/DDO154_benchmark_2eps/out/snp_013"
#infile_3 = "test3/hernquist/vector/DDO154_benchmark_hcs/out/snp_013"
...
#infile_2 = "test3/hernquist/scalar/DDO154_benchmark_ann/out/snp_013"
#infile_3 = "test3/hernquist/scalar/DDO154_benchmark_scatt/out/snp_013"
#logr_26MeV = np.loadtxt(fname='../../DDO154s_001.dat', delimiter=' ', usecols = 0)
#logrho_26MeV = np.loadtxt(fname='../../DDO154s_001.dat', delimiter=' ', usecols = 1)
...
print "Ntot_ann_scatt = ", Ntot_1
print "Ntot_ann = ", Ntot_2
print "Ntot_scatt = ", Ntot_3
print "\nMtot = ", Mtot
print "time = ", time, "\n"
...
### save the logrho information in dat files ##
#str_out_rho = "test3/hernquist/data/DDO154_vector_logrho_cmp.dat"
##str_out_rho = "test3/hernquist/data/DDO154_scalar_logrho_cmp.dat"
#
#file_out_rho = open(str_out_rho, "w+")
##file_out_rho.write("logmid_bins\tlogrhoH_th\tlogrhoNFW_th\tlogrho_bins_1\tlogdrho_bins_1_1p\tlogdrho_bins_1_1m\tlogrho_bins_2\tlogdrho_bins_2_1p\tlogdrho_bins_2_1m\tlogrho_bins_3\tlogdrho_bins_3_1p\tlogdrho_bins_3_1m\n")
#for i in range(0, len(logmid_bins)) :
#	file_out_rho.write("%.5f\t%.5f\t%.5f\t%.5f\t%.5f\t%.5f\t%.5f\t%.5f\t%.5f\t%.5f\t%.5f\t%.5f\n" %(logmid_bins[i], logrhoH_th[i], logrhoNFW_th[i], logrho_bins_1[i], logdrho_bins_1_1p[i], logdrho_bins_1_1m[i], logrho_bins_2[i], logdrho_bins_2_1p[i], logdrho_bins_2_1m[i], logrho_bins_3[i], logdrho_bins_3_1p[i], logdrho_bins_3_1m[i]))
#file_out_rho.close()


### save vel. disp. data ##
#str_out_stdv = "test3/hernquist/data/DDO154_vector_stdv_cmp.dat"
##str_out_stdv = "test3/hernquist/data/DDO154_scalar_stdv_cmp.dat"
#
...
## --> See stdv_results_test3.py for plots of stdv and logrho <-- ##
...
ax3.plot(mid_bins, vel_std_bins_1, color='darkviolet', linestyle='-', lw=2.0, label=r'Annihilation $+$ Scattering')
ax3.fill_between(mid_bins, dvel_std_bins_1_1m, dvel_std_bins_1_1p, color ='darkviolet', alpha=0.3)
ax3.plot(mid_bins, vel_std_bins_2, color='mediumpurple', linestyle='-', lw=2.0, label=r'Annihilation')
ax3.fill_between(mid_bins, dvel_std_bins_2_1m, dvel_std_bins_2_1p, color ='mediumpurple', alpha=0.3)
ax3.plot(mid_bins, vel_std_bins_3, color='deeppink', linestyle='-', lw=2.0, label=r'Scattering')
ax3.fill_between(mid_bins, dvel_std_bins_3_1m, dvel_std_bins_3_1p, color ='deeppink', alpha=0.3)
...
#ax3.plot(mid_bins, vel_std_bins_1, color='blue', linestyle='-', lw=2.0, label=r'Annihilation $+$ Scattering')
#ax3.fill_between(mid_bins, dvel_std_bins_1_1m, dvel_std_bins_1_1p, color ='blue', alpha=0.3)
#ax3.plot(mid_bins, vel_std_bins_2, color='slateblue', linestyle='-', lw=2.0, label=r'Annihilation')
#ax3.fill_between(mid_bins, dvel_std_bins_2_1m, dvel_std_bins_2_1p, color ='slateblue', alpha=0.3)
#ax3.plot(mid_bins, vel_std_bins_3, color='teal', linestyle='-', lw=2.0, label=r'Scattering')
#ax3.fill_between(mid_bins, dvel_std_bins_3_1m, dvel_std_bins_3_1p, color ='teal', alpha=0.3)
...
ax4.plot(mid_bins, rho_bins_1, color='blue', linestyle='-', lw=2.0, label=r'Annihilation $+$ Scattering')
ax4.fill_between(mid_bins, drho_bins_1_1m, drho_bins_1_1p, color ='blue', alpha=0.3)
ax4.plot(mid_bins, rho_bins_2, color='darkviolet', linestyle='-', lw=2.0, label=r'Annihilation')
ax4.fill_between(mid_bins, drho_bins_2_1m, drho_bins_2_1p, color ='darkviolet', alpha=0.3)
ax4.plot(mid_bins, rho_bins_3, color='green', linestyle='-', lw=2.0, label=r'Scattering')
...
ob4 = offsetbox.AnchoredText(s=text2, loc='lower center', pad=0.3, borderpad=0.85, frameon=True, prop=dict(color='black', size=18))
...
ax4_1.plot(logmid_bins, logrhoNFW_th, color ='black', linestyle ='-', lw=2.0, label=r'original NFW')
...
ax4_1.plot(logr_26MeV, logrho_26MeV, color ='darkviolet', linestyle ='-.', lw=2.0, label=r'Jim (NFW)')
#ax4_1.plot(logr_26MeV_H, logrho_26MeV_H, color ='steelblue', linestyle =':', lw=2.0, label=r'Jim (Hernquist)')
ax4_1.plot(logmid_bins, logrho_bins_1, color='violet', linestyle='-', lw=2.0, label=r'Annihilation $+$ Scattering')
ax4_1.fill_between(logmid_bins, logdrho_bins_1_1m, logdrho_bins_1_1p, color ='violet', alpha=0.3)
ax4_1.plot(logmid_bins, logrho_bins_2, color='mediumpurple', linestyle='-', lw=2.0, label=r'Annihilation')
ax4_1.fill_between(logmid_bins, logdrho_bins_2_1m, logdrho_bins_2_1p, color ='mediumpurple', alpha=0.3)
ax4_1.plot(logmid_bins, logrho_bins_3, color='deeppink', linestyle='-', lw=2.0, label=r'Scattering')
ax4_1.fill_between(logmid_bins, logdrho_bins_3_1m, logdrho_bins_3_1p, color ='deeppink', alpha=0.3)
ax4_1.legend([("red","--", " ", " "), ("black","-", " ", " "), ("orange","-", " ", " "), ("violet","-", "darkviolet","-."), ("mediumpurple","-", " "," "), ("deeppink","-", " "," ")], [r'Hernquist', r'original NFW', r'SIDM fit 1611.02716', r'Annihilation $+$ Scattering', r'Annihilation', r'Scattering'], handler_map={tuple: AnyObjectHandler()}, loc='upper right', prop={'size': 18})

#ax4_1.plot(logr_26MeV, logrho_26MeV, color ='blue', linestyle ='-.', lw=2.0, label=r'Jim (NFW)')
#ax4_1.plot(logmid_bins, logrho_bins_1, color='cyan', linestyle='-', lw=2.0, label=r'Annihilation $+$ Scattering')
#ax4_1.fill_between(logmid_bins, logdrho_bins_1_1m, logdrho_bins_1_1p, color ='cyan', alpha=0.3)
#ax4_1.plot(logmid_bins, logrho_bins_2, color='slateblue', linestyle='-', lw=2.0, label=r'Annihilation')
#ax4_1.fill_between(logmid_bins, logdrho_bins_2_1m, logdrho_bins_2_1p, color ='slateblue', alpha=0.3)
#ax4_1.plot(logmid_bins, logrho_bins_3, color='teal', linestyle='-', lw=2.0, label=r'Scattering')
#ax4_1.fill_between(logmid_bins, logdrho_bins_3_1m, logdrho_bins_3_1p, color ='teal', alpha=0.3)
#ax4_1.legend([("red","--", " ", " "), ("black","-", " ", " "), ("orange","-", " ", " "), ("cyan","-", "blue","-."), ("slateblue","-", " "," "), ("teal","-", " "," ")], [r'Hernquist', r'original NFW', r'SIDM fit 1611.02716', r'Annihilation $+$ Scattering', r'Annihilation', r'Scattering'], handler_map={tuple: AnyObjectHandler()}, loc='upper right', prop={'size': 18})
#
ax4_1.axvline(np.log10(eps), color='gray', linestyle = '--', lw=2.0)
ax4_1.text(x=np.log10(eps) + 0.03, y=-0.75, s=r'$\epsilon$', rotation=0, color='gray', fontsize=18)
ax4_1.grid(False)
...
ob4_1 = offsetbox.AnchoredText(s=text2, loc='lower left', pad=0.3, borderpad=0.85, frameon=True, prop=dict(color='black', size=18))
ob4_1.patch.set(boxstyle='round', edgecolor='lightgray', alpha=1.0)
...
ob4_1_1 = offsetbox.AnchoredText(s=text1, loc='lower center', pad=0.3, borderpad=0.85, frameon=True, prop=dict(color='black', size=18))
ob4_1_1.patch.set(boxstyle='round', edgecolor='lightgray', alpha=1.0)
ax4_1.add_artist(ob4_1_1)
fig4_1.tight_layout()
fig4_1.show()
#fig4_1.savefig('test3/figs/logrho_vs_r_DDO154_vec26_cmp.pdf', dpi=200, bbox_inches='tight', pad_inches=0.08)
##fig4_1.savefig('test3/figs/logrho_vs_r_DDO154_scal001_cmp.pdf', dpi=200, bbox_inches='tight', pad_inches=0.08)
