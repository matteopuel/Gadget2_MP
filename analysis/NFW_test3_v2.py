...
##---------# (DDO 154 dSph galaxy) #---------#
#outfile = "nfw_test3_dsph_v2_4"

#outfile = "nfw_test3_dsph_v2"
outfile = "nfw_test3_dsph_v2_try"
...
fname1 = 'nfw_test3_dsph.dat' #--> use python in "NFW.py"
...
#fname1 = 'nfw_test3_dsph.dat'
#E_list  = np.loadtxt(fname=fname1, delimiter='\t', usecols = 0, skiprows=1)
#fE_list = np.loadtxt(fname=fname1, delimiter='\t', usecols = 1, skiprows=1)
...
for i in range(0, Ntothalf) :
	...
	Y = 1.1 # fE_Phi is max of fE_interp() for a given r since fE_interp(E) is monotonically decreases with E
	while (Y * fE_Phi) > fE_interp(Phi_r * (1.0 - q**2)) : # first instance must be True
	...
	vtot = q * vesc(s=s1, c=c1, Vv=Vv1) # see http://www.artcompsci.org/kali/vol/plummer/ch04.html and https://ui.adsabs.harvard.edu/abs/1974A%26A....37..183A/abstract
