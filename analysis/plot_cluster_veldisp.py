...
infile_4 = "test3/hernquist/scalar/A2537_002/out/snp_010"
...
circ_radius_data_exp = np.loadtxt(fname='../../old_data/A2537_data_exp1.dat', delimiter=' ', usecols = 0)
projected_stdv_data_exp = np.loadtxt(fname='../../old_data/A2537_data_exp1.dat', delimiter=' ', usecols = 1)
cr_data_exp = []
proj_stdv_data_exp = [] # symmetric uncertainty
dcr_data_exp_l = [] # left error bar from mean point (because asymmetric error)
dcr_data_exp_r = [] # left error bar from mean point (because asymmetric error)
dproj_stdv_data_exp = []

#first point
cr_data_exp.append(0.779)
proj_stdv_data_exp.append(0.5 * projected_stdv_data_exp[1] + 0.5 * projected_stdv_data_exp[0])
dcr_data_exp_l.append(0.0)
dcr_data_exp_r.append(circ_radius_data_exp[1])
dproj_stdv_data_exp.append(0.5 * projected_stdv_data_exp[1] - 0.5 * projected_stdv_data_exp[0])

#second point
cr_data_exp.append(circ_radius_data_exp[3])
proj_stdv_data_exp.append(projected_stdv_data_exp[3])
dcr_data_exp_l.append(circ_radius_data_exp[2])
dcr_data_exp_r.append(circ_radius_data_exp[4])
dproj_stdv_data_exp.append(0.5 * projected_stdv_data_exp[4] - 0.5 * projected_stdv_data_exp[2])

#third point
cr_data_exp.append(circ_radius_data_exp[6])
proj_stdv_data_exp.append(projected_stdv_data_exp[6])
dcr_data_exp_l.append(circ_radius_data_exp[5])
dcr_data_exp_r.append(circ_radius_data_exp[7])
dproj_stdv_data_exp.append(0.5 * projected_stdv_data_exp[7] - 0.5 * projected_stdv_data_exp[5])

#fourth point
cr_data_exp.append(circ_radius_data_exp[9])
proj_stdv_data_exp.append(projected_stdv_data_exp[9])
dcr_data_exp_l.append(circ_radius_data_exp[8])
dcr_data_exp_r.append(circ_radius_data_exp[10])
dproj_stdv_data_exp.append(0.5 * projected_stdv_data_exp[10] - 0.5 * projected_stdv_data_exp[8])

#fifth point
cr_data_exp.append(circ_radius_data_exp[12])
proj_stdv_data_exp.append(projected_stdv_data_exp[12])
dcr_data_exp_l.append(circ_radius_data_exp[11])
dcr_data_exp_r.append(circ_radius_data_exp[13])
dproj_stdv_data_exp.append(0.5 * projected_stdv_data_exp[13] - 0.5 * projected_stdv_data_exp[11])

print "\ncircularized kpc:"
print "cr_data_exp = ", cr_data_exp
print "proj_stdv_data_exp = ", proj_stdv_data_exp
print "dcr_data_exp_l = ", dcr_data_exp_l
print "dcr_data_exp_r = ", dcr_data_exp_r
print "dproj_stdv_data_exp = ", dproj_stdv_data_exp


## from Table 6 in https://arxiv.org/pdf/1209.1391.pdf: radial bins (not-circularized, oriented along a) in arcsec vs projected stdv ##
...
# they can be circularized by using the axis ratio b/a = 0.74
boa = 0.74
...
cr_data_exp_tab_l = [arcsec2kpc(arcs=el, z=z_a2537) for el in rb_data_exp_tab_l]
cr_data_exp_tab_r = [arcsec2kpc(arcs=el, z=z_a2537) for el in rb_data_exp_tab_r]


## OBS: if I multiply the values in rb_data_exp_tab_r/l by 3.8, we get exactly the values in dcr_data_exp_r/l

print "\nnon-circularized arcsec (TABLE):"
print "rb_data_exp_tab_l = ", rb_data_exp_tab_l
print "rb_data_exp_tab_r = ", rb_data_exp_tab_r
print "proj_stdv_data_exp_tab = ", proj_stdv_data_exp_tab
print "dproj_stdv_data_exp_tab = ", dproj_stdv_data_exp_tab

print "\ncr_data_exp_tab_l = ", cr_data_exp_tab_l
print "cr_data_exp_tab_r = ", cr_data_exp_tab_r


## Import observational data: not-circularized radii (oriented along a) vs projected stdv ##
nocirc_radius_data_exp1 = np.loadtxt(fname='../../old_data/A2537_data_exp.dat', delimiter=' ', usecols = 0)
projected_stdv_data_exp1 = np.loadtxt(fname='../../old_data/A2537_data_exp.dat', delimiter=' ', usecols = 1)
ncr_data_exp1 = []
proj_stdv_data_exp1 = [] # symmetric uncertainty
dncr_data_exp_l1 = [] # left error bar from mean point (because asymmetric error)
dncr_data_exp_r1 = [] # left error bar from mean point (because asymmetric error)
dproj_stdv_data_exp1 = dproj_stdv_data_exp_tab

#first point
ncr_data_exp1.append(nocirc_radius_data_exp1[1])
proj_stdv_data_exp1.append(projected_stdv_data_exp1[1])
dncr_data_exp_l1.append(nocirc_radius_data_exp1[0])
dncr_data_exp_r1.append(nocirc_radius_data_exp1[2])

#second point
ncr_data_exp1.append(nocirc_radius_data_exp1[4])
proj_stdv_data_exp1.append(projected_stdv_data_exp1[4])
dncr_data_exp_l1.append(nocirc_radius_data_exp1[3])
dncr_data_exp_r1.append(nocirc_radius_data_exp1[5])

#third point
ncr_data_exp1.append(nocirc_radius_data_exp1[7])
proj_stdv_data_exp1.append(projected_stdv_data_exp1[7])
dncr_data_exp_l1.append(nocirc_radius_data_exp1[6])
dncr_data_exp_r1.append(nocirc_radius_data_exp1[8])

#fourth point
ncr_data_exp1.append(nocirc_radius_data_exp1[10])
proj_stdv_data_exp1.append(projected_stdv_data_exp1[10])
dncr_data_exp_l1.append(nocirc_radius_data_exp1[9])
dncr_data_exp_r1.append(nocirc_radius_data_exp1[11])

#fifth point
ncr_data_exp1.append(nocirc_radius_data_exp1[13])
proj_stdv_data_exp1.append(projected_stdv_data_exp1[13])
dncr_data_exp_l1.append(nocirc_radius_data_exp1[12])
dncr_data_exp_r1.append(nocirc_radius_data_exp1[14])


print "\nnon-circularized kpc:"
print "ncr_data_exp1 = ", ncr_data_exp1
print "proj_stdv_data_exp1 = ", proj_stdv_data_exp1
print "dncr_data_exp_l1 = ", dncr_data_exp_l1
print "dncr_data_exp_r1 = ", dncr_data_exp_r1
print "dproj_stdv_data_exp1 = ", dproj_stdv_data_exp1


cr_data_exp1 = [el * np.sqrt(boa) for el in ncr_data_exp1]
dcr_data_exp_l1 = [el * np.sqrt(boa) for el in dncr_data_exp_l1]
dcr_data_exp_r1 = [el * np.sqrt(boa) for el in dncr_data_exp_r1]

print "\ncr_data_exp1 = ", cr_data_exp1
print "dcr_data_exp_l1 = ", dcr_data_exp_l1
print "dcr_data_exp_r1 = ", dcr_data_exp_r1


# OBS: if I divide the values in dncr_data_exp_l1/r1 by 1.15, I get the values in dcr_data_exp_l/r (= it corresponds to 1.0/np.sqrt(boa))
...
vel_bins_r_1 = [[] for j in range(0, len(bins)-1)]
vel_bins_theta_1 = [[] for j in range(0, len(bins)-1)]
vel_bins_phi_1 = [[] for j in range(0, len(bins)-1)]
pos_bins_1 = [[] for j in range(0, len(bins)-1)]
for i in range(0, len(pos_r_1)) :	
	for j in range(0, len(bins)-1) :
		if pos_r_1[i] >= bins[j] and pos_r_1[i] < bins[j+1] :
			Npart_bins_1[j] += 1
			vel_bins_r_1[j].append(vel_r_1[i])
			vel_bins_theta_1[j].append(vel_theta_1[i])
			vel_bins_phi_1[j].append(vel_phi_1[i])
...
vel_mean_bins_r_1 = []
dvel_mean_bins_r_1 = []
vel_mean_bins_theta_1 = []
dvel_mean_bins_theta_1 = []
vel_mean_bins_phi_1 = []
dvel_mean_bins_phi_1 = []
rho_bins_1 = []
drho_bins_1 = []
for j in range(0, len(bins)-1) :
	vel_sum_r_j = sum(vel_bins_r_1[j]) # len(vel_bins[j]) == Npart_bins[j]
	vel_sum_theta_j = sum(vel_bins_theta_1[j])
	vel_sum_phi_j = sum(vel_bins_phi_1[j])
	hwidth_j = 0.5 * (bins[j+1] - bins[j])
	mid_bins.append(bins[j] + hwidth_j)
	dmid_bins.append(hwidth_j)
	if (Npart_bins_1[j] != 0) :
		vel_mean_bins_r_1.append(vel_sum_r_j/Npart_bins_1[j])
		dvel_mean_bins_r_1.append(vel_sum_r_j/(Npart_bins_1[j]**1.5))
		vel_mean_bins_theta_1.append(vel_sum_theta_j/Npart_bins_1[j])
		dvel_mean_bins_theta_1.append(vel_sum_theta_j/(Npart_bins_1[j]**1.5))
		vel_mean_bins_phi_1.append(vel_sum_phi_j/Npart_bins_1[j])
		dvel_mean_bins_phi_1.append(vel_sum_phi_j/(Npart_bins_1[j]**1.5))
		...
		vel_mean_bins_r_1.append(0.0)
		dvel_mean_bins_r_1.append(0.0)
		vel_mean_bins_theta_1.append(0.0)
		dvel_mean_bins_theta_1.append(0.0)
		vel_mean_bins_phi_1.append(0.0)
		dvel_mean_bins_phi_1.append(0.0)
...
vel_std_bins_r_1 = []
dvel_std_bins_r_1 = []
vel_std_bins_theta_1 = []
dvel_std_bins_theta_1 = []
vel_std_bins_phi_1 = []
dvel_std_bins_phi_1 = []
for j in range(0, len(vel_bins_r_1)) : # len(vel_bins) == len(bins)-1
	diff2_j = 0
	diff_j = 0
	for i in range(0, len(vel_bins_r_1[j])) :
		diff2_j += (vel_bins_r_1[j][i] - vel_mean_bins_r_1[j])**2
		diff_j += (vel_bins_r_1[j][i] - vel_mean_bins_r_1[j])
	if Npart_bins_1[j] != 0 :
		vel_std_bins_r_1.append(np.sqrt(diff2_j / Npart_bins_1[j]))
		if diff2_j != 0 :
			tmp_j = (2.0 * diff_j / Npart_bins_1[j] * dvel_mean_bins_r_1[j])**2 + (diff2_j / Npart_bins_1[j]**2 * dNpart_bins_1[j])**2
			dvel_std_bins_r_1.append(np.sqrt(tmp_j) / (2.0 * np.sqrt(diff2_j / Npart_bins_1[j])))
		else :
			dvel_std_bins_r_1.append(0.0)
	else :
		vel_std_bins_r_1.append(0.0)
		dvel_std_bins_r_1.append(0.0)

	diff2_j = 0
	diff_j = 0
	for i in range(0, len(vel_bins_theta_1[j])) :
		diff2_j += (vel_bins_theta_1[j][i] - vel_mean_bins_theta_1[j])**2
		diff_j += (vel_bins_theta_1[j][i] - vel_mean_bins_theta_1[j])
	if Npart_bins_1[j] != 0 :
		vel_std_bins_theta_1.append(np.sqrt(diff2_j / Npart_bins_1[j]))
		if diff2_j != 0 :
			tmp_j = (2.0 * diff_j / Npart_bins_1[j] * dvel_mean_bins_theta_1[j])**2 + (diff2_j / Npart_bins_1[j]**2 * dNpart_bins_1[j])**2
			dvel_std_bins_theta_1.append(np.sqrt(tmp_j) / (2.0 * np.sqrt(diff2_j / Npart_bins_1[j])))
		else :
			dvel_std_bins_theta_1.append(0.0)
	else :
		vel_std_bins_theta_1.append(0.0)
		dvel_std_bins_theta_1.append(0.0)

	diff2_j = 0
	diff_j = 0
	for i in range(0, len(vel_bins_phi_1[j])) :
		diff2_j += (vel_bins_phi_1[j][i] - vel_mean_bins_phi_1[j])**2
		diff_j += (vel_bins_phi_1[j][i] - vel_mean_bins_phi_1[j])
	if Npart_bins_1[j] != 0 :
		vel_std_bins_phi_1.append(np.sqrt(diff2_j / Npart_bins_1[j]))
		if diff2_j != 0 :
			tmp_j = (2.0 * diff_j / Npart_bins_1[j] * dvel_mean_bins_phi_1[j])**2 + (diff2_j / Npart_bins_1[j]**2 * dNpart_bins_1[j])**2
			dvel_std_bins_phi_1.append(np.sqrt(tmp_j) / (2.0 * np.sqrt(diff2_j / Npart_bins_1[j])))
		else :
			dvel_std_bins_phi_1.append(0.0)
	else :
		vel_std_bins_phi_1.append(0.0)
		dvel_std_bins_phi_1.append(0.0)


vel_bins_1 = vel_bins_r_1
vel_mean_bins_1 = vel_mean_bins_r_1
dvel_mean_bins_1 = dvel_mean_bins_r_1
vel_std_bins_1 = vel_std_bins_r_1
dvel_std_bins_1 = dvel_std_bins_r_1

beta = [(1.0 - (vel_std_bins_theta_1[j]**2 + vel_std_bins_phi_1[j]**2) / (2.0 * vel_std_bins_r_1[j]**2)) if vel_std_bins_r_1[j] != 0 else 0.0 for j in range(0, len(bins)-1)]

print "vel_std_bins_r_1[0:10] = ", vel_std_bins_r_1[0:10]
print "vel_std_bins_theta_1[0:10] = ", vel_std_bins_theta_1[0:10]
print "vel_std_bins_phi_1[0:10] = ", vel_std_bins_phi_1[0:10]
print "\nbeta[0:10] = ", beta[0:10] 
