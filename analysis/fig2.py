...
Mv1_g = 1.23 # * 1e10 Msun (total mass -> dSph galaxy)
rv1_g = 41.5 # kpc
...
ax1.plot(logmid_bins_vg, logrhoNFW_th_vg, color ='black', linestyle ='-', lw=2.0, label=r'NFW')
ax1.plot(logr_SIDM_g, logrho_SIDM_g, color ='orange', linestyle ='-', lw=3.0, label=r'SIDM fit 1611.02716')

ax1.plot(logr_34MeV_vg, logrho_34MeV_vg, color ='blue', linestyle ='-.', lw=2.0, label=r'$m_V = 34$ MeV')
ax1.plot(logr_26MeV_vg, logrho_26MeV_vg, color ='darkviolet', linestyle ='-.', lw=2.0, label=r'$m_V = 26$ MeV')
ax1.plot(logr_17MeV_vg, logrho_17MeV_vg, color ='green', linestyle ='-.', lw=2.0, label=r'$m_V = 17$ MeV')
...
ob1_11 = offsetbox.AnchoredText(s=text3_vg, loc='lower left', pad=0.3, borderpad=0.85, frameon=True, prop=dict(color='black', size=18))
ob1_11.patch.set(boxstyle='round', edgecolor='lightgray', alpha=1.0)
ob1_11.patch.set(boxstyle='round', edgecolor='lightgray', alpha=1.0)
ax1.add_artist(ob1_11)

fig1.tight_layout()
fig1.show()
fig1.savefig('test3/figs/logrho_vs_r_DDO154_vector_Jim.pdf', dpi=200, bbox_inches='tight', pad_inches=0.08)
...
#text3_sg = r'$r_s = {0:0.1f}$'.format(rs1_g) + r' kpc' + '\n' + r'$\rho_s = {0:s}$'.format(as_si(rhos1_g*1.0e10, 1)) + r' M$_{\odot}$/kpc$^3$' + '\n' + r'$V_v = {0:0.0f}$'.format(Vv1_g) + r' km/s' + '\n' + r'$c_v = {0:0.1f}$'.format(c1_g) + '\n' + r'$M_v = {0:s}$'.format(as_si(Mv1_g*1.0e10, 1)) + r' M$_{\odot}$' + '\n' + r'$r_v = {0:0.1f}$'.format(rv1_g) + r' kpc'
text3_sg = r'$r_s = {0:0.1f}$'.format(rs1_g) + r' kpc' + '\n' + r'$\rho_s = {0:s}$'.format(as_si(rhos1_g*1.0e10, 1)) + r' M$_{\odot}$/kpc$^3$' + '\n' + r'$V_{200} = 36$' + r' km/s' + '\n' + r'$c_{200} = 12.2$' + '\n' + r'$M_{200} = 1.2 \times 10^{10}$' + r' M$_{\odot}$' + '\n' + r'$r_{200} = 41.5$' + r' kpc'
...
ax2.plot(logmid_bins_sg, logrhoNFW_th_sg, color ='black', linestyle ='-', lw=2.0, label=r'NFW')
ax2.plot(logr_SIDM_g, logrho_SIDM_g, color ='orange', linestyle ='-', lw=3.0, label=r'SIDM fit 1611.02716')

ax2.plot(logr_001_sg, logrho_001_sg, color ='blue', linestyle ='-.', lw=2.0, label=r'$\alpha^{\prime} = 0.01$')
ax2.plot(logr_0015_sg, logrho_0015_sg, color ='darkviolet', linestyle ='-.', lw=2.0, label=r'$\alpha^{\prime} = 0.015$')
ax2.plot(logr_002_sg, logrho_002_sg, color ='green', linestyle ='-.', lw=2.0, label=r'$\alpha^{\prime} = 0.02$')
...
ob2_11 = offsetbox.AnchoredText(s=text3_sg, loc='lower left', pad=0.3, borderpad=0.85, frameon=True, prop=dict(color='black', size=18))
ob2_11.patch.set(boxstyle='round', edgecolor='lightgray', alpha=1.0)
ax2.add_artist(ob2_11)

fig2.tight_layout()
fig2.show()
fig2.savefig('test3/figs/logrho_vs_r_DDO154_scalar_Jim.pdf', dpi=200, bbox_inches='tight', pad_inches=0.08)
...
rv1_c = 2046 # kpc
Mv1_c = 127767 # * 1e10 Msun (total mass -> galaxy cluster)
...
ax3.plot(logmid_bins_vc, logrhoNFW_th_vc, color ='black', linestyle ='-', lw=2.0, label=r'NFW')
...
ax3.plot(logr_68MeV_vc, logrho_68MeV_vc, color ='blue', linestyle ='-.', lw=2.0, label=r'$m_V = 68$ MeV')
ax3.plot(logr_51MeV_vc, logrho_51MeV_vc, color ='darkviolet', linestyle ='-.', lw=2.0, label=r'$m_V = 51$ MeV')
ax3.plot(logr_43MeV_vc, logrho_43MeV_vc, color ='green', linestyle ='-.', lw=2.0, label=r'$m_V = 43$ MeV')
ax3.plot(logr_34MeV_vc, logrho_34MeV_vc, color ='brown', linestyle ='-.', lw=2.0, label=r'$m_V = 34$ MeV')
...
ob3_11 = offsetbox.AnchoredText(s=text3_vc, loc='lower left', pad=0.3, borderpad=0.85, frameon=True, prop=dict(color='black', size=18))
ob3_11.patch.set(boxstyle='round', edgecolor='lightgray', alpha=1.0)
ax3.add_artist(ob3_11)

fig3.tight_layout()
fig3.show()
fig3.savefig('test3/figs/logrho_vs_r_A2537_vector_Jim.pdf', dpi=200, bbox_inches='tight', pad_inches=0.08)
...
#text3_sc = r'$r_s = {0:0.0f}$'.format(rs1_c) + r' kpc' + '\n' + r'$\rho_s = {0:s}$'.format(as_si(rhos1_c*1.0e10, 1)) + r' M$_{\odot}$/kpc$^3$' + '\n' + r'$V_v = {0:0.0f}$'.format(Vv1_c) + r' km/s' + '\n' + r'$c_v = {0:0.2f}$'.format(c1_c) + '\n' + r'$M_v = {0:s}$'.format(as_si(Mv1_c*1.0e10, 1)) + r' M$_{\odot}$' + '\n' + r'$r_v = {0:0.0f}$'.format(rv1_c) + r' kpc'
text3_sc = r'$r_s = {0:0.0f}$'.format(rs1_c) + r' kpc' + '\n' + r'$\rho_s = {0:s}$'.format(as_si(rhos1_c*1.0e10, 1)) + r' M$_{\odot}$/kpc$^3$' + '\n' + r'$V_{200} = 1639$' + r' km/s' + '\n' + r'$c_{200} = 4.63$' + '\n' + r'$M_{200} = 1.3 \times 10^{15}$' + r' M$_{\odot}$' + '\n' + r'$r_{200} = 2046$' + r' kpc'
...
ax4.plot(logmid_bins_sc, logrhoNFW_th_sc, color ='black', linestyle ='-', lw=2.0, label=r'NFW')
...
ax4.plot(logr_001_sc, logrho_001_sc, color ='blue', linestyle ='-.', lw=2.0, label=r'$\alpha^{\prime} = 0.01$')
ax4.plot(logr_0015_sc, logrho_0015_sc, color ='darkviolet', linestyle ='-.', lw=2.0, label=r'$\alpha^{\prime} = 0.015$')
ax4.plot(logr_002_sc, logrho_002_sc, color ='green', linestyle ='-.', lw=2.0, label=r'$\alpha^{\prime} = 0.02$')
...
ob4_11 = offsetbox.AnchoredText(s=text3_sc, loc='lower left', pad=0.3, borderpad=0.85, frameon=True, prop=dict(color='black', size=18))
ob4_11.patch.set(boxstyle='round', edgecolor='lightgray', alpha=1.0)
ax4.add_artist(ob4_11)

fig4.tight_layout()
fig4.show()
fig4.savefig('test3/figs/logrho_vs_r_A2537_scalar_Jim.pdf', dpi=200, bbox_inches='tight', pad_inches=0.08)
