...
#m0 = 1.0e14 / (128**3)
#mp2 = M2 * 1.0e10 / (128**3)
#print "eps = ", 4.4 * (mp2/m0)**(1.0/3)
#sys.exit()


## Hernquist and simulation parameters in code units!
##---------# (used for test 2) #---------#
#outfile = "hernquist_test_v1"
...
##-------# (used for checks) #-------#
#outfile = "hernquist_test3_v1"
#M = 3.0 # * 1e10 Msun
#a = 10.0 # kpc
#Ntot = int(128**3)
#eps = 0.3 # kpc
#dt = 10.0 # Gyr
#boxside = 100000.0 # kpc (= 150 Mpc)
##--> TimeEnd = 10.220120181 if TimeBegin = 0


##------# (real simulation: DDO 154) #-------#
## Springel (https://arxiv.org/pdf/astro-ph/0411108.pdf), see HvsNFW.py code
##outfile = "hernquist_v1_S"
##M = 2.3 # * 1e10 Msun
##a = 8.982285853787648 # kpc
##inferred M,a from rhos1 and rs1
#outfile = "hernquist_v1_S1"
...
##inferred M,a from rhos1 and rs1, see HvsNFW.py code
## Springel
#outfile = "hernquist_v1_S1_cluster"
...
##------# (real simulation: DDO 126) #-------#
##inferred M,a from rhos1 and rs1
## Springel
#outfile = "hernquist_v1_S1_ddo126"
...
for i in range(0, Ntothalf) :
	...
	vx_com += (vx * mp / Xmax / M) # Xmax dependence should be cancel out
	vy_com += (vy * mp / Xmax / M)
	vz_com += (vz * mp / Xmax / M)
