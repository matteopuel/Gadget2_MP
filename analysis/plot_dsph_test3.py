...
ax3.plot(mid_bins, vel_std_bins_1, color='blue', linestyle='-', lw=2.0, label=r'$m_V = 26$ MeV')
ax3.fill_between(mid_bins, dvel_std_bins_1_1m, dvel_std_bins_1_1p, color ='blue', alpha=0.3)
ax3.plot(mid_bins, vel_std_bins_2, color='darkviolet', linestyle='-', lw=2.0, label=r'$m_V = 34$ MeV')
