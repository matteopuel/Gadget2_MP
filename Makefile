...
#--------------------------------------- Oscillating ADM model
## MPUEL: add our model details (read README)
OPT   +=  -DADM_MODEL_ON
...
OPT   +=  -DTEST_HERNQUIST_HALO_SCATT # test 2 (scattering)
#OPT   +=  -DTEST_HERNQUIST_HALO_ANN # test 2 (annihilation)
...
CC       =  mpicc   
OPTIMIZE =  -O3 -Wall
GSL_INCL =  -I/usr/local/include #-I/usr/local/opt/gsl/include
GSL_LIBS =  -L/usr/local/lib #-L/usr/local/opt/gsl/lib
FFTW_INCL= 	-I/usr/local/include
FFTW_LIBS= 	-L/usr/local/lib
HDF5INCL =  -I/usr/local/include -DH5_USE_16_API #-I/usr/local/opt/hdf5/include 
HDF5LIB  =  -L/usr/local/lib -lhdf5 -lz #-L/usr/local/opt/hdf5/lib
MPICHLIB =	-L/usr/lib
endif
...
CC = mpicc
OPTIMIZE = -Wall
# Libraries used by Gadget
GSL_INCL = -I/cvmfs/soft.computecanada.ca/easybuild/software/2017/avx2/Compiler/intel2016.4/gsl/2.3/include
GSL_LIBS = -L/cvmfs/soft.computecanada.ca/easybuild/software/2017/avx2/Compiler/intel2016.4/gsl/2.3/lib -Wl,--rpath -Wl,/cvmfs/soft.computecanada.ca/easybuild/software/2017/avx2/Compiler/intel2016.4/gsl/2.3/lib -lgslcblas -lgsl
FFTW_INCL = -I/cvmfs/soft.computecanada.ca/easybuild/software/2017/avx2/Compiler/intel2016.4/fftw/3.3.6/include
FFTW_LIBS = -L/cvmfs/soft.computecanada.ca/easybuild/software/2017/avx2/Compiler/intel2016.4/fftw/3.3.6/lib -Wl,--rpath -Wl,/cvmfs/soft.computecanada.ca/easybuild/software/2017/avx2/Compiler/intel2016.4/fftw/3.3.6/lib
HDF5_INCL = -I/cvmfs/soft.computecanada.ca/easybuild/software/2017/avx2/Compiler/intel2016.4/hdf5/1.8.18/include -DH5_USE_16_API
HDF5_LIBS = -L/cvmfs/soft.computecanada.ca/easybuild/software/2017/avx2/Compiler/intel2016.4/hdf5/1.8.18/lib -Wl,--rpath -Wl,/cvmfs/soft.computecanada.ca/easybuild/software/2017/avx2/Compiler/intel2016.4/hdf5/1.8.18/lib -lhdf5 -lz
MPICHLIB = -L/cvmfs/soft.computecanada.ca/easybuild/software/2017/avx2/Compiler/intel2016.4/openmpi/2.1.1/lib -Wl,--rpath -Wl,/cvmfs/soft.computecanada.ca/easybuild/software/2017/avx2/Compiler/intel2016.4/openmpi/2.1.1/lib -lmpi
EXTRA_LDFLAGS = -shared-intel  # only for intel compiler
endif
...
## MPUEL: add additional file if ADM_MODEL_ON activated
ifeq (ADM_MODEL_ON,$(findstring ADM_MODEL_ON, $(OPT)))
OBJS += adm_model.o
endif
